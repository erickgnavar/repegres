...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.code'
        db.add_column(u'repo_student', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.code'
        db.delete_column(u'repo_student', 'code')
