...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Student.languages'
        db.delete_column(u'repo_student', 'languages_id')
    ...
    def backwards(self, orm):
        # Adding field 'Student.languages'
        db.add_column(u'repo_student', 'languages',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_set', null=True, to=orm['repo.Language']),
                      keep_default=False)
