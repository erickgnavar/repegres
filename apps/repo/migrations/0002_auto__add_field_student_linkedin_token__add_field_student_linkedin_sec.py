...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.linkedin_token'
        db.add_column(u'repo_student', 'linkedin_token',
    ...
    def backwards(self, orm):
        # Deleting field 'Student.linkedin_token'
        db.delete_column(u'repo_student', 'linkedin_token')
    ...
    models = {
        ...
        'repo.student': {
            ...
            'linkedin_secret': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
